...
alter table weblog_custom_template add constraint wct_weblogid_fk
    foreign key ( websiteid ) references weblog( id ) on delete no action on update no action enforced enable query optimization ;

alter table custom_template_rendition add constraint ctr_templateid_fk
    foreign key ( templateid ) references weblog_custom_template( id ) on delete no action on update no action enforced enable query optimization ;
...
alter table bookmark add constraint bm_folderid_fk
    foreign key ( folderid ) references bookmark_folder( id ) on delete no action on update no action enforced enable query optimization ;
