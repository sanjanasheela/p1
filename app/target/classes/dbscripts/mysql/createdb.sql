...
alter table roller_user add constraint ru_username_uq unique ( username(40) );
...
alter table weblog add constraint ws_handle_uq unique (handle(40));
...
create index wp_name_idx on weblog_custom_template(name(40));
create index wp_link_idx on weblog_custom_template(link(40));
