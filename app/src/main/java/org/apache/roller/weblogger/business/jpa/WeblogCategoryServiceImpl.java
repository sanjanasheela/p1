...
import org.apache.roller.weblogger.business.WeblogCategoryService;
...
public class WeblogCategoryServiceImpl implements WeblogCategoryService {
    ...
    private static final Log log = LogFactory.getLog(WeblogCategoryServiceImpl.class);
    
    @com.google.inject.Inject
    protected WeblogCategoryServiceImpl() {
        log.debug("Instantiating Weblog Category Service");
    }
