...
/**
 * Service for weblog theme management operations.
 * Extracts theme-related business logic from Weblog POJO.
 */
public interface WeblogThemeService {
     ...
     * @return WeblogTheme The theme, or null if no theme selected.
     */
