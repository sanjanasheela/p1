...
/**
 * Service for weblog plugin management operations.
 * Extracts plugin-related business logic from Weblog POJO.
 */
public interface WeblogPluginService {
     ...
     *
     * @param weblog The weblog to get plugins for.
     * @return Map of initialized plugin instances.
     */
